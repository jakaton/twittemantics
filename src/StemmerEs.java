public class  StemmerEs {
    ...
    private static int getNextVowelPos(String word, int start) {
        int len = strlen(word);
    ...
    private static int getNextConsonantPos(String word, int start) {
        int len = strlen(word);
        for (int i = start; i < len; i++) {
            if (!is_vowel(word.charAt(i))) {
                return i;
    ...
    private static boolean endsin(String word, String suffix) {
    ...
    private static String endsinArr(String word, String[] suffixes) {
...
//---------------------------------------------------------------------------------------------------------------------------------
    ...
    public static String substr(String word, int start, int length) {
    ...
    public static String substr(String word, int i) {
    ...
    private static int strlen(String word) {
        return word.length();
    }
}
